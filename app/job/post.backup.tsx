            ...
            return (
              ...
              >
                <View style={[
                  ...
                  !isDone && !isCurrent && { backgroundColor: Colors.white, borderWidth: 2, borderColor: Colors.gray2 }
                ]}>
                  {isDone
                    ? <Ionicons name="checkmark" size={12} color={Colors.white} />
                    : <Ionicons name={step.icon as any} size={12} color={isCurrent ? Colors.white : Colors.gray4} />}
                </View>
                <Text style={[styles.stepDotLabel, isCurrent && styles.stepDotLabelActive, isDone && styles.stepDotLabelDone]}>
                  {step.label}
                </Text>
              </TouchableOpacity>
            );
